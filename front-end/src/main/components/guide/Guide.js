                ...
                <Col>
                  ...
                  <Row className={style["manageBody"]}>
                    ...
                    <div className={style["guideContent"]}>
                      <ol>
                        <li>
                          사용자는 구단 관리 페이지에서 <span>1번 영역</span>
                          에서 자신의 보유 타자와 <span>2번, 3번 영역</span>에서
                        ...
                        <li>
                          4번 영역의 'SAVE' 버튼을 활성화하면 사용자가 변경한
                          현재 상태를 저장합니다.
                        </li>
                      </ol>
                    </div>
                  ...
                  <Row className={style["marketBody"]}>
                    ...
                    <div className={style["guideContent"]}>
                      <ol>
                        ...
                        <li>
                          5번 영역의 'SAVE' 버튼을 활성화하면 사용자가 변경한
                          현재 상태를 저장합니다.
                        </li>
                      </ol>
                    </div>
